...
public class Rider {
    ...
    // NEW: Check if rider matches search term
    public boolean matchesSearch(String searchTerm) {
        ...
        return riderId.toLowerCase().contains(term) ||
               riderName.toLowerCase().contains(term) ||
               currentLocation.toLowerCase().contains(term) ||
