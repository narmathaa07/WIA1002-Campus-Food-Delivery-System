...
public class WelcomePanel extends JPanel {
    ...
    public WelcomePanel(MainFrame frame) {
        ...
        center.add(title);
        center.add(Box.createVerticalStrut(6)); // close
        center.add(subtitle);
        center.add(Box.createVerticalStrut(26)); // spacing before arrow
        ...
        arrow.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                frame.showSystem(); // ✅ go to SYSTEM card
            }
    ...
    static class ArrowCircleButton extends JComponent {
        ...
        public ArrowCircleButton() {
            setPreferredSize(new Dimension(150, 150)); // ✅ BIGGER
